...
Program main
    ...
    integer i,j,k,l,count_kappa,count_delta,ratio_sim,ratio_msd,count_sim,count_msd,crash !! loop variables
    ...
    68 format(2x,'Time',9x,'ana. MSD_x',9x,'<∆x**2>',9x,'D_x',9x,'ana. MSD_t',9x,'<∆Θ**2>',9x,'D_t')
    ...
    open(unit=382,file=TRIM(rue_total)//"PDF.txt"); write(382,96) kappa, ini_height
