...
Program main
    use MATHS
    implicit none    
    integer :: Nmax = 8000*800 !! Define the maximum number of steps
    ...
    dt = 1.0d-6 * clight / (rayon * sqrt(2.0d0 * eps)) * tratio
    1108 continue
    ...
    do i=1,Nmax-1
        ...
        write(32,72) i*dt,position(1,i),position(2,i),position(3,i)
...
real*8 function forcevalue(z)
    ...
    coulombmax = 4.0d-4 * 0.0d0 !! namely the "B" shown by Maxime, PHYSICAL REVIEW RESEARCH 3, L032011 (2021)
