...
plot GBf0 using 1:($4*30.0e-1) title "Boltzmann" with line dt 1 lt 6 lw 6 lc rgb 'black',\
dataf0 using 1:2 index i title "κ = 0.0e-1" with lines lw 4 lc rgb 'red',\
#dataf1 using 1:2 index i title "κ = 0.4e-1" with lines lw 2 lc rgb '#1f78b4',\
#dataf2 using 1:2 index i title "κ = 0.8e-1" with lines lw 2 lc rgb '#b15928',\
#dataf3 using 1:2 index i title "κ = 1.2e-1" with lines lw 2 lc rgb 'grey',\
dataf4 using 1:2 index i title "κ = 1.6e-1" with lines lw 2 lc rgb '#ff7f00',\
