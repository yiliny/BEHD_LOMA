...
Program main
    ...
    integer i,j,k,l,count_kappa,count_delta,count_sim,count_msd,crash,count_particle,count_crash !! Loop variables
    ...
    continue !! Constant Parameters
        ...
        ratio_sim = 1; ratio_msd = 100 !! Here are two variables to accelerate calculations for Euler method & MSD.
        ...
        ratio_pdfz = ceiling(zmax*80) !! Here is the ratio to determine how many data would be taken part for PDF calculation.
        ...
        outp_max = 5 !! Max particle number in position.txt file output
    continue
    ...
    kxi = kappa*xi; kxe = kappa*xi*eps !! non-dimensional parameters w/o units.
        ...
        case(1) !! Loop
            ...
            count_crash = 0 !! Added 24/10/2023
            ...
            if (MOD(count_particle,ceiling(num_particle/4.0d0)).eq.0) then
                write(30,*) "   # Sim. done, particle",count_particle
                write(*,*) "   # Sim. done, particle",count_particle
                if (count_crash > 0) then
                    write(30,*) "   #",count_particle,"failed",count_crash,"times."
                    write(*,*) "   #",count_particle,"failed",count_crash,"times."
                end if
