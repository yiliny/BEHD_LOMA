...
real*8 rayon,rhosty,rhosol,rhoa,mass,mz,mx,mt,grav,kappa,eps,xi,kxi,kxe,temp,k_B,beta,clight,dt,csquare,kk,q0
common/para/rayon,rhosty,rhosol,rhoa,mass,mz,mx,mt,grav,kappa,eps,xi,kxi,kxe,temp,k_B,beta,clight,dt,csquare,kk,q0
